...
from wtforms.validators import DataRequired, URL, Optional, ValidationError, Length, Email, \
    EqualTo  # need to install email validator separately
    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            ...
            try:
                ...
                flash("Oops! Sometimes went wrong! Try Again")
            else:
